  ...
  render() {
    return (
      <div>
        ...
        <InteriorDetails listing={this.state.listing} />
        <h3 className="details">Property details</h3>
        <PropertyDetails listing={this.state.listing} />
        <h3 className="details">Construction details</h3>
        <ConstructionDetails listing={this.state.listing} />
        <h3 className="details">Utilities / Green Energy Details</h3>
        <UtilitiesDetails listing={this.state.listing} />
        <h3 className="details">Community and Neighborhood Details</h3>
        <CommunityDetails listing={this.state.listing} />
        <h3 className="details">HOA and financial details</h3>
        <HoaDetails listing={this.state.listing} />
